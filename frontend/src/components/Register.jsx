          ...
          <div>
            ...
            <div className="flex gap-2 bg-neutral-800 rounded-xl border border-neutral-700 p-1">
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-3 py-3 px-5 rounded-lg transition-all duration-200 font-medium ${
                  form.role === "student"
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-3 py-3 px-5 rounded-lg transition-all duration-200 font-medium ${
                  form.role === "teacher"
                    ? "bg-gradient-to-r from-cyan-500 to-purple-500 text-black shadow-md shadow-purple-500/30"
                    : "text-neutral-300 hover:text-neutral-200 hover:bg-neutral-700/50"
                }`}
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
